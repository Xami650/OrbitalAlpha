...
4. Open **Command Prompt** or **PowerShell** and go to the ActiveMQ `bin` folder:
...
5. Start ActiveMQ in console mode:
...
6. Verify that ActiveMQ is running:
...
7. Keep this terminal open while running the Java modules.
