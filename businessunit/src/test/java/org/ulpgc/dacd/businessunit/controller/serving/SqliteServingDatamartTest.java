...
class SqliteServingDatamartTest {
    ...
    void savesAndReadsBackSnapshot() {
        ...
        assertThat(result.getFirst().commodity()).isEqualTo("WEAT");
        assertThat(result.getFirst().riskLevel()).isEqualTo(RiskLevel.HIGH);
        assertThat(result.getFirst().riskScore()).isEqualTo(89.5);
        assertThat(result.getFirst().reason()).isEqualTo("High risk reason");
    }
    ...
    void upsertUpdatesExistingSnapshot() {
        ...
        assertThat(result).hasSize(1);
        assertThat(result.getFirst().riskLevel()).isEqualTo(RiskLevel.HIGH);
        assertThat(result.getFirst().riskScore()).isEqualTo(90.0);
    }
